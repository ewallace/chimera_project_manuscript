...
We go beyond previous results by showing that poly(A) site usage is consistent across terminators that are placed on plasmids in different promoter, coding sequence, and downstream contexts that are different from the native genomic context (Figure \@ref(fig:quantseq-polyA-site-usage)).
The sequences and relative usages of the poly(A) sites are not affected by inserting motifs into tTSA1 constructs, where the insertion sites were upstream of the termination region.
...
A possible explanation for the novel poly(A) site is that motifs 2 and 3 were inserted close to or in the termination region and into a evolutionarily conserved element of tRPS3, as detected by pHastCons [@Siepel2005].
