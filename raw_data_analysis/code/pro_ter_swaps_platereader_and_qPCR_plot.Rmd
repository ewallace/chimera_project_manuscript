...
UTR_length_panel <- plot_grid(normalised_plot_RPS3, 
...
```{r combine-norm-diagram, fig.height = 8}
...
```{r create_raw_fluo_low_and_high_pro, fig.height = 9}
