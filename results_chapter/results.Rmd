...
We next mapped transcript termination, via poly(A) site usage, in a subset of reporter constructs, for 2 reasons.
...
For these constructs we performed paired-end sequencing of 3' mRNA-Seq libraries following QuantSeq REV protocol ([@Moll2014] and see methods).
...
Overall, poly(A) site mapping showed that poly(A) sites depended only on the terminator sequence, not on the coding sequence or promoter context.
